package com.example.jokemaster.view
...
import com.example.jokemaster.R
import com.example.jokemaster.model.Joke
import com.example.jokemaster.presentation.JokeDayPresenter
...
class JokeDayFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imageView = view.findViewById(R.id.image_joke)
